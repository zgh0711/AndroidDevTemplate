 ...
 */
public class BMRadioButton extends AppCompatRadioButton {
    ...
    public BMRadioButton(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (R.styleable.BMRadioButton_BMdrawableSize == attr) {
                ...
                Log.v("drawableSize", "drawableSize:" + drawableSize);
                ...
                Log.v("drawableSize", "drawableWidth:" + drawableWidth);
                ...
                Log.v("drawableSize", "drawableHeight:" + drawableHeight);
