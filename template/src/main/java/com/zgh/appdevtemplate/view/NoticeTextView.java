...
public class NoticeTextView extends TextSwitcher implements ViewSwitcher.ViewFactory, View.OnTouchListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.NoticeTextView);
        //获取xml文件中属性，如果没有用默认属性
        textColor = ta.getColor(R.styleable.NoticeTextView_noticeTextColor, textColor);
        timePeriod = ta.getInt(R.styleable.NoticeTextView_noticeRollingTime, timePeriod);
        textSize = ta.getDimensionPixelSize(R.styleable.NoticeTextView_noticeTextSize, sp2px(defaultTextSize));
        Log.i("----", textSize + "");
