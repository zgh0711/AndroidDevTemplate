...
public class FlyBanner extends RelativeLayout {
    //加载网络图片用到了 glide，而使用 glide 的时候需要用到 applicationContext
    ...
    //使用 glide 的时候需要传入 applicationContext ，否则可能为 crash
    public void setImagesUrl(List<String> urls, Context applicationContext) {
